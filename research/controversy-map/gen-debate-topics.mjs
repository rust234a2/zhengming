 ...
 *
 * 数据实情（2026-09-14 核对）：27 议题 / 37 论点，其中**只有 2 个议题天然同时有正反论点**。
 * 对策（ROLLOUT §5）：
 *   - 2 个真实成对议题作为首批（`paired: true`）；
 ...
 * 议题分布实情：27 个真实议题里只有 ${pairedTopics.length} 个天然同时有正反论点，
...
const stats = {
  "真实议题总数": byQuestion.size,
  "真实论点总数": claims.length,
