...
**示例图**：每个范式配一张原理示意图，文件在 [`prototypes/visual-references/`](../../prototypes/visual-references/)；想一次看全，直接打开 [图集页](../../prototypes/visual-references/index.html)。图中所有图均为**原理示意**，不是真实案例截图。
...
![凸包分组前后对比](../../prototypes/visual-references/01-convex-hull.svg)
...
![直线与分层边捆绑的对比](../../prototypes/visual-references/02-edge-bundling.svg)
...
![替换式下钻与透镜式的对比](../../prototypes/visual-references/03-focus-lens.svg)

![语义缩放的三档视图](../../prototypes/visual-references/04-semantic-zoom.svg)
...
![圆周弦图布局](../../prototypes/visual-references/05-radial-chord.svg)
...
![容器框的表达能力与盲区](../../prototypes/visual-references/06-container-frame.svg)
...
![气象图语法的等值线表达](../../prototypes/visual-references/07-weather-map.svg)
...
![八域小倍数对比](../../prototypes/visual-references/08-small-multiples.svg)
...
![四个视觉编码通道](../../prototypes/visual-references/09-encoding-channels.svg)
...
**示例图集（本仓）**
- 图集页：`prototypes/visual-references/index.html`
- 单张 SVG：`01-convex-hull` / `02-edge-bundling` / `03-focus-lens` / `04-semantic-zoom` / `05-radial-chord` / `06-container-frame` / `07-weather-map` / `08-small-multiples` / `09-encoding-channels`
